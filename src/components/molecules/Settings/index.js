...
const SettingsPresenter = ({ id, className }) => {
  ...
  return (
    <div className={ [ styles.root, className ].join(' ') }>
      <FontAwesomeIcon className={ styles.icon } icon={faEllipsisH} onClick={settings.toggle} />
      <ul className={ settings.display ? [styles.menu, styles.active].join(' ') : styles.menu }>
        <li>
